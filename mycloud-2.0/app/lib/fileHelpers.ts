...
export const getFilePath = async (folderStackIDs: number[], fileName: string, userId: string): Promise<string | null> => {
...
export const getFileFullPath = (folderMap: Map<number, DBFolder>, file: DBFile, userId: string): string => {
